    ...
    return (
      <main className = "stan-width">
        ...
        <p className=" text-base/8 ">
          ...
          "to make combat fast-paced, deadly, and engaging by having WP start low, scale very slowly, and emphasizing active damage mitigation " + 
          "via abilities, spells, and strategic thinking. Players make dynamic choices to avoid or reduce incoming damage rather than relying on " + 
          "HP bloat.  As well as to give players  the opportunity to build highly unique customized characters that may or may not follow " + 
          "traditional archetypal builds."}
        </p>
      </main>
    );
}
