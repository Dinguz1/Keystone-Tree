...
const Footer = () => {
    ...
    return (
        <footer className="flex flex-col items-center p-6 gap-6 xl:p-6 bg-(--bg-secondary) md:flex-row md:p-4">
            <div className="w-full flex flex-col md:gap-2 md:text-center">
                ...
                <ul className="flex justify-center md:grid grid-cols-6 md:w-60 gap-y-6 gap-6">
                    <li className="flex col-span-2 justify-center">
                    ...
                    <li className="flex col-span-2 col-start-2 justify-center">
                        <Link href="#" className="flex">
                            <Image src="/reddit.svg" alt="Reddit Logo" height={logoHeight} width={logoWidth} />
                        </Link>
                    </li>
                    <li className="flex col-span-2 col-start-4 justify-center">
                        <Link href="#" className="flex">
            ...
            <div className="divider" />
            <div className="flex flex-row-reverse gap-4 md:text-center">
